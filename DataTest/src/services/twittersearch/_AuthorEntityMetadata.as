...
[ExcludeClass]
internal class _AuthorEntityMetadata extends AbstractEntityMetadata
{
	private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("name", "uri");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("name", "uri");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("name", "uri");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;    
    model_internal static var entityName:String = "Author";
    model_internal static var dependentsOnMap:Object;    
    model_internal static var dependedOnServices:Array =  new Array();
    
    
    model_internal var _instance:_Super_Author;
    model_internal static var _nullStyle:Style = new Style();
    
    public function _AuthorEntityMetadata(author : _Super_Author)
    {
        ...
        model_internal::_instance = author;     
    }
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity Author");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
       if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity Author");  
     ...
     override public function getValue(propertyName:String):Object    
     {
         ...
         {
         	throw new Error(propertyName + " does not exist for entity Author");
         }     
    ...
    [Bindable(event="propertyChange")]   
    public function get uriStyle():Style
    {
		return model_internal::_nullStyle;		
    }      
