package{
	...
	public class Cylinder extends Sprite{
		...
		private function init():void
		{
			...
			{
				triangles[index] = 		new Triangle(points[index],points[index+3],points[index+1],0x000000);
				triangles[index + 1] = 	new Triangle(points[index], points[index+2],points[index+3],0xcccccc);
				index += 2;
			}
			triangles[index] = 			new Triangle(points[index],points[1],points[index+1],0x000000);
			triangles[index+1] = 		new Triangle(points[index],points[0],points[1],0xcccccc);
