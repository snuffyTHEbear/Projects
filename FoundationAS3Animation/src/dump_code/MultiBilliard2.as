package
{
	...
	public class MultiBilliard2 extends Sprite
	{
		...
		private var numBalls:uint = 2;
		private var bounce:Number = -1.0;
		private var collideWall:Sound;
		private var collideBall:Sound;
		...
		private function init():void
		{
			...
			collideWall = new Sound(new URLRequest("chimes/1.mp3"));
			collideBall = new Sound(new URLRequest("chimes/2.mp3"));
			...
			for(var i:uint = 0; i < numBalls; i++)
			{
				...
				var ball2:CreateCircle = new CreateCircle(radius/4, 0x000000)
				ball.mass = radius;
