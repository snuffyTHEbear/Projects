package
{
	...
	public class Isometrics_2 extends Sprite
	{
		...
		private function init():void
		{
			...
			block.addBox(new IsometricObject(0,0,0,10,25,10,false,0,true,0xCCCCCC));
			block.x = centreX;
			block.y = centreY;
			addChild(block);
			...
			for(var i:uint=0;i<900;i++)
			{
				...
				grid.addBox(new IsometricObject(xPos,0,yPos,10,0,10,true,0,true,0xffffff));
			}
