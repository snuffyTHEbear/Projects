package models
{
	...
	public class test extends TriangleMesh3D
	{
		...
		public function test( material:MaterialObject3D=null, initObject:Object=null )
		{
			super( material, new Array(), new Array(), "");
			verts = this.geometry.vertices;
			faceAr= this.geometry.faces;
			uvs   =new Array();
			v(-6.97539,0.0,-6.97539);
			v(6.97539,0.0,-6.97539);
			v(-6.97539,0.0,6.97539);
			v(6.97539,0.0,6.97539);
			v(-6.97539,5.93064,-6.97539);
			v(6.97539,5.93064,-6.97539);
			v(-6.97539,5.93064,6.97539);
			v(6.97539,5.93064,6.97539);
			uv(0.0,0.0);
