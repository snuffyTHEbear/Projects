package
{
	...
	public class ThreeDeeLissajousFigure2 extends Sprite
	{
		...
		private var colour:uint = 0x000000;
		...
		private function update():void
		{
			...
			{
				var c:CreateCircle3D = new CreateCircle3D(3, 0); //3, 0, colours[i], 1, points[i].x, points[i].y, points[i].z);
				c.move(points[i].x, points[i].y, points[i].z);
				circles.push(c);
				addChild(c);
			}
			render();
